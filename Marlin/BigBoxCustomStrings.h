...
//
#define BB_CUSTOM_LEVEL_BED_CORNERS_X_MIN (abs(X_PROBE_OFFSET_FROM_EXTRUDER) + 10)
#define BB_CUSTOM_LEVEL_BED_CORNERS_X_MAX (X_MAX_POS-10)
#define BB_CUSTOM_LEVEL_BED_CORNERS_Y_MIN 10
#define BB_CUSTOM_LEVEL_BED_CORNERS_Y_MAX (Y_MAX_POS-10)
