...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE) //(X_BED_SIZE - MIN_PROBE_EDGE)
...
#define MANUAL_X_HOME_POS -39//.9 //-38 //0
