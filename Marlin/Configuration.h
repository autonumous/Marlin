...
#define HOTEND_OFFSET_X {0.0, 38.60} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, 0.70}  // (in mm) for each extruder, offset of the hotend on the Y axis
//M218 T1 X38.6 Y0.7 ; set extruder 1 offset ;20160811
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,180,400,443.8}  //{ 80, 80, 4000, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          {150, 150, 6, 50}  //{300, 300, 6, 50} // { 300, 300, 5, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 5000 } //{ 3000, 3000, 100, 10000 }
...
#define DEFAULT_RETRACT_ACCELERATION  3000 //5000    // E acceleration for retracts
 ...
 */
#define DEFAULT_XJERK                 8.0 //20.0
#define DEFAULT_YJERK                 8.0 //20.0
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.5 //-2.4 //-2.2 //-2.6 //0   // Z offset: -below +above  [the nozzle]
...
#define Z_CLEARANCE_BETWEEN_PROBES 3//2 //3 // Z_PROBE_TRAVEL_HEIGHT? // 5 // Z Clearance between probe points
...
#define Z_HOMING_HEIGHT 5 //3  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_GRID_MAX_POINTS_X 3  //ABL_GRID_MAX_POINTS_[XY]
  ...
  #define MESH_HOME_SEARCH_Z 5  // Z after Home, bed somewhere below but above 0.0.  *   //removed From RC, added by paul 20170320
 ...
 */
#define Z_PROBE_END_SCRIPT  "G91\nT0\nG1 Z1 F1000\nG90\nT0\nG1 X70 Y200 F3000\nG1 Y240 F2000\nG91\nG1 Z-1 F1000\nM300 P100\n"  //("G90\nT0\nG1 X70 Y200 F3000\nG1 Y240 F2000\nG1 E-4 F4500"); // Dock //"G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (30) //((X_MIN_POS + X_MAX_POS) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (30) //((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
...
// use G27 P2
  ...
  #define NOZZLE_PARK_POINT {70,200,20} //Dock Position should be 235  // { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
#endif
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //100
#define LCD_FEEDBACK_FREQUENCY_HZ 500 //1000
