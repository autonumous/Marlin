...
#define EXTRUDE_MAXLENGTH 900//(X_MAX_LENGTH+Y_MAX_LENGTH) //200  // This is aslong as the Bowden tube is
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,180,400,408.12, 408.12} //443.8 //{ 80, 80, 4000, 500 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.2 //1.4 //-2.58  // Z offset: -below +above  [the nozzle]
...
#define Y_MAX_POS 240 //Y_BED_SIZE
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER - LEFT_PROBE_BED_POSITION) //(X_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE) //(X_BED_SIZE - MIN_PROBE_EDGE)
  #define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE-FRONT_PROBE_BED_POSITION) //(Y_BED_SIZE - MIN_PROBE_EDGE)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (30) //((X_MIN_POS + X_MAX_POS) / 2)  ((X_BED_SIZE) / 2)  // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (30) //((Y_MIN_POS + Y_MAX_POS) / 2)  ((Y_BED_SIZE) / 2)  // Y point for Z homing when homing all axis (G28).
#endif
