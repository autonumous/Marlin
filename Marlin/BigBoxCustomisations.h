...
#define BIGBOX_CUSTOMISATIONS_H
	...
	#define BIGBOX_CUSTOMISED_MENUS
		...
		//
		// XY Loop  useful for testing full coverage of XY plane v2
		//
		...
		//
		// Dock Extruder to waste box // 20170106 PB  v2
		//
