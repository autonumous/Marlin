...
#define X_HOME_BUMP_MM 5//3 //5
#define Y_HOME_BUMP_MM 5//3 //5
#define Z_HOME_BUMP_MM 3 //2
...
// made available here for specialized needs, ie dual extruder setup.
    ...
    #else
      #define MESH_MIN_X (MESH_INSET) //(max(X_MIN_POS + MESH_INSET, 0))
      #define MESH_MAX_X (X_MAX_POS + X_BED_SIZE - (MESH_INSET) )  //(min(X_MAX_POS - (MESH_INSET), X_BED_SIZE))
      #define MESH_MIN_Y (MESH_INSET)  //(max(Y_MIN_POS + MESH_INSET, 0))
      #define MESH_MAX_Y (Y_BED_SIZE-(MESH_INSET) )  //(min(Y_MAX_POS - (MESH_INSET), Y_BED_SIZE))
    #endif
  #endif
    ...
    #else
      #define UBL_MESH_MIN_X (UBL_MESH_INSET)  //(max(X_MIN_POS + UBL_MESH_INSET, 0))
      #define UBL_MESH_MAX_X (X_BED_SIZE + X_MIN_POS - UBL_MESH_INSET)  //(min(X_MAX_POS - (UBL_MESH_INSET), X_BED_SIZE))
      #define UBL_MESH_MIN_Y (UBL_MESH_INSET)  //(max(Y_MIN_POS + UBL_MESH_INSET, 0))
      #define UBL_MESH_MAX_Y (Y_BED_SIZE-(UBL_MESH_INSET))  //(min(Y_MAX_POS - (UBL_MESH_INSET), Y_BED_SIZE))
    #endif
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_X_POS 70                 // X position of hotend
