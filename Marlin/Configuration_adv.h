...
<<<<<<< HEAD
  ...
  #define MESH_MAX_X (X_MAX_POS + X_BED_SIZE - (MESH_INSET) ) //(X_BED_SIZE - (MESH_INSET))  //(X_MAX_POS - (MESH_INSET))
  #define MESH_MIN_Y (MESH_INSET) //(Y_MIN_POS + MESH_INSET)
  #define MESH_MAX_Y (Y_BED_SIZE-(MESH_INSET) ) //(Y_MAX_POS - (MESH_INSET))
#elif ENABLED(AUTO_BED_LEVELING_UBL)
  #define UBL_MESH_MIN_X (UBL_MESH_INSET) //(X_MIN_POS + UBL_MESH_INSET)
  #define UBL_MESH_MAX_X (X_BED_SIZE + X_MIN_POS - UBL_MESH_INSET) //(X_BED_SIZE - (UBL_MESH_INSET))   //(X_MAX_POS - (UBL_MESH_INSET))
  #define UBL_MESH_MIN_Y (UBL_MESH_INSET) //(Y_MIN_POS + UBL_MESH_INSET)
  #define UBL_MESH_MAX_Y (Y_BED_SIZE-(UBL_MESH_INSET)) //(Y_MAX_POS - (UBL_MESH_INSET))
