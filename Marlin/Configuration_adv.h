...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR 20 //40    //For BigBox 40 = 0.01mm //1 //faster movements
#endif
...
// made available here for specialized needs, ie dual extruder setup.
  ...
  #define UBL_MESH_MAX_X (X_MAX_POS + X_MIN_POS - UBL_MESH_INSET)   //(X_MAX_POS - (UBL_MESH_INSET))
  #define UBL_MESH_MIN_Y (UBL_MESH_INSET) //(Y_MIN_POS + UBL_MESH_INSET)
  #define UBL_MESH_MAX_Y (200-(UBL_MESH_INSET)) //(Y_MAX_POS - (UBL_MESH_INSET))
#endif
...
#define FILAMENT_CHANGE_FEATURE
  ...
  #define FILAMENT_CHANGE_X_POS 70 //3             // X position of hotend
  #define FILAMENT_CHANGE_Y_POS 240 //3             // Y position of hotend
