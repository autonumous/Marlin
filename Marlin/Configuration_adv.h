...
//#define DUAL_X_CARRIAGE
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET (X_MAX_POS/2)
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.12 //0.22  // Unit: mm compression per 1mm/s extruder speed
...
// @section leveling
  ...
  #define MESH_MAX_X (X_BED_SIZE + X_MIN_POS - MESH_INSET)  
